...
public class LevelManager : MonoBehaviour
{
    ...
    public void SetCurrentLevel(int level)
    {
        ...
        {
            currentLevel = level;
            MizuLog.General($"Level Manager: Current level changed to {currentLevel}");
        }
    }
    ...
    public void CompleteLevel()
    {
        if (currentLevel + 1 <= maxLevel && currentLevel + 1 > unlockedLevel)
        {
            ...
            MizuLog.General($"Level Manager: Level {unlockedLevel} unlocked! Current level stays at {currentLevel}");
        }
        SaveLevelData();
    }
