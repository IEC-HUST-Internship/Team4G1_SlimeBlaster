...
public class UpgradeButton : MonoBehaviour
{
    ...
    private void LoadUpgradeLevel()
    {
        if (SaveSystem.Instance != null && nodeInstance != null && nodeInstance.data != null)
        {
            ...
            if (savedLevel > 0)
            {
                ...
                MizuLog.General($"📥 Loaded {nodeInstance.data.upgradeName}: Level {savedLevel}");
            }
        }
    }
    ...
    public void PerformUpgrade()
    {
        ...
        if (playerStats.HasEnoughCurrency(nodeInstance.data.costUnit, cost))
        {
            ...
            ApplyUpgradeEffect();
            MizuLog.General($"{nodeInstance.data.upgradeName} upgraded to level {nodeInstance.currentLevel}");
        ...
        {
            MizuLog.General("Not enough resources!");
        }
    }
