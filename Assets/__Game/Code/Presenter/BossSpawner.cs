...
public class BossSpawner : MonoBehaviour
{
    ...
    private void SpawnBoss()
    {
        ...
        {
            MizuLog.Spawn("BossSpawner: Boss not spawning - not current level");
            return;
        }
        ...
        MizuLog.Spawn($"Boss spawned at {startPoint.position}, moving toward {bossTargetPos}");
    }
    ...
    private void DestroyBoss()
    {
        ...
        {
            bossEnemy.SetActive(false);
            MizuLog.Spawn("Boss destroyed after 3 minutes!");
        }
    }
